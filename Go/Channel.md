...
![https://img.draveness.me/2020-01-28-15802171487042-shared-memory.png](https://img.draveness.me/2020-01-28-15802171487042-shared-memory.png)
...
![https://img.draveness.me/2020-01-28-15802171487080-channel-and-goroutines.png](https://img.draveness.me/2020-01-28-15802171487080-channel-and-goroutines.png)

上图中的两个 Goroutine，一个会向 Channel 中发送数据，另一个会从 Channel 中接收数据，它们两者能够独立运行并不存在直接关联，但是能通过 Channel 间接完成通信。

## 2. 数据结构

Go 语言的 Channel 在运行时使用 `runtime.hchan` 结构体表示。我们在 Go 语言中创建新的 Channe时，实际上创建的都是如下所示的结构：
...
![https://img.draveness.me/2020-01-29-15802354027250-channel-direct-send.png](https://img.draveness.me/2020-01-29-15802354027250-channel-direct-send.png)
...
![https://img.draveness.me/2020-01-28-15802171487104-channel-buffer-send.png](https://img.draveness.me/2020-01-28-15802171487104-channel-buffer-send.png)
...
![https://img.draveness.me/2020-01-28-15802171487111-channel-receive-node.png](https://img.draveness.me/2020-01-28-15802171487111-channel-receive-node.png)
...
![https://img.draveness.me/2020-01-28-15802171487118-channel-receive-from-sendq.png](https://img.draveness.me/2020-01-28-15802171487118-channel-receive-from-sendq.png)
...
![https://img.draveness.me/2020-01-28-15802171487125-channel-buffer-receive.png](https://img.draveness.me/2020-01-28-15802171487125-channel-buffer-receive.png)
...
编译器会将用于关闭管道的 `close` 关键字转换成 `OCLOSE` 节点以及 函数。
